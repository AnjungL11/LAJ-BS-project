...
ALTER TABLE images ADD COLUMN taken_time DATETIME DEFAULT NULL COMMENT '拍摄时间(EXIF)';
ALTER TABLE images ADD COLUMN metadata JSON DEFAULT NULL COMMENT '完整元数据';
